...
:date, :fig, :black_fruit_other, :blue_fruit_level, :blueberry,
  		:dried_blueberry, :plum, :plum_skin, :blue_fruit_other,
:fruit_type, :flowers_level, :rose, :violet,
:lavender, :dried_flowers, :potpourri, :flowers_other,
:herbs_level, :fresh_herbs, :dried_herbs, :tomatoe_leaf,
:basil, :oregeno, :fennel, :herbs_other, :vegetal_level,
:green_bell_pepper_capsicum, :vegetal_fresh_herbs, :vegetal_dried_herbs,
 ...
 :mineral_stone_sulfur_level, :sulfur, :slate_petrol, :metallic, :flit, :dust, :chalk, :limestone,
  ...
  :coconut, :light_toast, :heavy_toast, :sawdust, :sandalwood, :pencil_shavings, :oak_vanilla_smoke_coconut_other,
  :sweetness, :alcohol, :tannin, :bitter, :balanced, :length, :complexity, :quality_for_price, :quality_for_price_rate)";
